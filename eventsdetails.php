    ...
    <?php foreach($result as $r){ ?>
        ...
        <form method="GET">
            <div class="row text-center">
                ...
                <div class="col-75">
                    <textarea  style="height:200px; width:500px;" ><?php echo $r["announcement"];?></textarea>
                </div>
            </div>
          ...
          <section class="bg-accent bg-position-center bg-size-cover py-3 py-sm-5" style="background-image: url(<?php echo 'eventsimage/' .$r["eiamge"]; ?>); max-height: 100%">
            <div class="container py-5">
              <div class="row pt-md-5 pb-lg-5 justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-10 text-center py-xl-3">
                  <h1 class=" pb-sm-3">
                    <span class="" >Welcome to <b><?php echo $r["etitle"]; ?></b><br></span>
                  </h1>
